import { AppStatus, IAuth, IAuthModules, IClient, ICombinedTokenContext, IConfig, ICordova, ICore, IDeploy, IDevice, IEventEmitter, IFacebookAuth, IGoogleAuth, IInsights, ILogger, IPush, ISingleUserService, IStorageStrategy, IUserContext } from './definitions';
...
export declare class Container {
    ...
    readonly auth: IAuth;
    readonly facebookAuth: IFacebookAuth;
    readonly googleAuth: IGoogleAuth;
    readonly push: IPush;
